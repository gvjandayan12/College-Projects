...
<body>
    <form id="formSubmission" class="profileDiv" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post">
        ...
        <input id="age1" type="text" class="ageInput" value="<?php echo htmlspecialchars($age1) ?>" name="age1" placeholder="Enter Age" >

        <label for="address1" class="addressLabel">Address :</label>
        <input id="address1" type="text" class="addressInput" value="<?php echo htmlspecialchars($address1) ?>" name="address1" placeholder="Enter Address" >
